...
<br><br><br>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="updateannAction.jsp?annID=<%= annID %>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width: 1125px">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="annTitle" maxlength="50" value="<%= ann.getAnnTitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="annContent" maxlength="2048" style="height: 350px;"><%= ann.getAnnContent() %></textarea></td>
						</tr>
					</tbody>
				</table>	
