		...
		<div class="container">				
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.jsp">Home </a> <span class="lnr lnr-arrow-right"></span> <a href=""> Intro</a><span class="lnr lnr-arrow-right"></span> <a href="intro2.jsp"> 임원진 소개</a></p>
				</div>	
			</div>
		</div>
	</section>
		...
		<div class="container-fluid">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 info-area-right">
					<h1>임원진 소개</h1>
					<p>2020학년도 임원진을 소개합니다!</p>
				</div>
			</div>
		</div>	
	</section>
	<section class="info-area pb-120">
		<div class="col-lg-3 no-padding info-area-left"></div>
		<div class="container-fluid col-lg-6">
			<img class="img-fluid" src="img/l2.jpg" alt="">
		</div>
		<div class="col-lg-3 no-padding info-area-right"></div>
	</section>
	<section class="info-area pb-120">
		<div class="col-lg-3 no-padding info-area-left"></div>
		<div class="container-fluid col-lg-6">
			<img class="img-fluid" src="img/leader3.jpg" alt="">
		</div>
		<div class="col-lg-3 no-padding info-area-right"></div>
	</section>
	<!-- End info Area -->	
