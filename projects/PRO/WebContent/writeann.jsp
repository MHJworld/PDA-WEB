...
<br><br><br>
	...
	<div class="container">
		<div class="row">
			<form enctype="multipart/form-data" action="writeannAction.jsp" method="post">
				<table class="table table-striped"
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="annTitle" maxlength="50"/></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="annContent" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
						<tr>
							<td>파일 : <input type="file" name="annFileName"><br></td>
						</tr>
					</tbody>
				</table>	
