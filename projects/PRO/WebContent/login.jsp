		...
		<div class="container">				
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="">Guest</a><span class="lnr lnr-arrow-right"></span>  <a href="login.jsp">로그인</a></p>
				</div>	
			</div>
		</div>
	</section>
	  	...
	  	<!-- 점보트론 -->
	   	<div class="jumbotron" style="padding-top: 20px; width: 1100px">
	   		<form method="post" action="loginAction.jsp">
	    		<h3 style="text-align: center; padding-bottom: 30px; width">로그인화면</h3>
