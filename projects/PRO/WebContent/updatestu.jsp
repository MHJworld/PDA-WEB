...
<br><br><br>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="updatestuAction.jsp?stuID=<%= stuID %>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width: 1125px">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="stuTitle" maxlength="50" value="<%= stu.getStuTitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="stuContent" maxlength="2048" style="height: 350px;"><%= stu.getStuContent() %></textarea></td>
						</tr>
					</tbody>
				</table>	
