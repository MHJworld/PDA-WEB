		...
		<div class="container">				
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.jsp">Home </a> <span class="lnr lnr-arrow-right"></span> <a href=""> Guest</a><span class="lnr lnr-arrow-right"></span> <a href="join.jsp">회원가입</a></p>
				</div>	
			</div>
		</div>
	</section>
...
<br><br><br>
	...
	<!-- Start join Area -->
	<div class="container">
		<div class="jumbotron" style="padding-top: 20px; width: 1100px">
			<form method="post" action="joinAction.jsp">
				<h3 style="text-align: center; padding-bottom: 30px">회원가입</h3>
				...
				<div class="form-group">
					<input type="text" class="form-control" placeholder="학번" name="userHakbun" maxlength="20">
				</div>
