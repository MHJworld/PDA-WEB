		...
		<div class="container">				
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> Member</a><span class="lnr lnr-arrow-right"></span>  <a href="member20.jsp"> 20학번</a></p>
				</div>	
			</div>
		</div>
	</section>
				...
				<div class="col-lg-12 pb-30">
					<div class="single-carusel row align-items-center">
						...
						<div class="detials col-12 col-md-6">
							<h2>We are waiting for NEW members!!</h2>
							<p><br>
								신입생 여러분들의 많은 가입 부탁드립니다.
							</p>
						</div>
					</div>
				</div>																		
