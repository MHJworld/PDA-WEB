		...
		<div class="container">				
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.jsp">Home </a> <span class="lnr lnr-arrow-right"></span> <a href="">Intro</a><span class="lnr lnr-arrow-right"></span> <a href="intro3.jsp"> 동아리방 소개</a></p>
				</div>	
			</div>
		</div>
	</section>
		...
		<div class="container-fluid">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 info-area-right">
					<h1>동아리방 소개</h1>
					<p>넓은 책상과 컴퓨터, 그리고 우주 공강이 있는 동아리 학우들을 미니 침대까지 구비되어 있습니다. 최고의 시설과 최고의 복지를 자랑하는 저희 PDA-Pro 동아리 입니다.</p>
					<br>
					<p>
						잘생긴 회장, 예쁜 부회장, 우수한 임원진, 그리고 좋은 동아리 학우들과 이 공간을 가꾸어 나가고 있습니다.
					</p>
				</div>
			</div>
		</div>	
