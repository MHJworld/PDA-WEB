...
<br><br><br>
	...
	<div class="container">
		<div class="row">
			<form enctype="multipart/form-data" action="writepdaAction.jsp" method="post">
				<table class="table table-striped"
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="pdaTitle" maxlength="50"/></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="pdaContent" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
						<tr>
							<td>파일 : <input type="file" name="pdastuFileName"><br></td>
						</tr>
					</tbody>
				</table>	
