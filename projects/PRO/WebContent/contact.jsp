...
<head>
	...
	<script>
		function myMap() {  
  			...
  			var myCenter = new google.maps.LatLng(36.6256, 127.4544);
  			var mapOptions = {
  				center: myCenter, 
    			zoom: 17
  			};
		...
		<div class="container">				
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span> <a href="contact.jsp">Contact</a></p>
				</div>	
			</div>
		</div>
	</section>
	...
	<section class="contact-page-area section-gap">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12 d-flex flex-column address-wrap"><br><br><br></div>
