...
<br><br><br>
	...
	<!-- Start update Area -->
	<div class="container course-detail-area">
		<div class="row">
			<form method="post" action="updateAction.jsp?pdaID=<%= pdaID %>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width: 1125px">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="pdaTitle" maxlength="50" value="<%= pda.getPdaTitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="pdaContent" maxlength="2048" style="height: 350px;"><%= pda.getPdaContent() %></textarea></td>
						</tr>
					</tbody>
				</table>	
