		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="meminfoAction.jsp">동아리 회원 정보</a></p>
				</div>
			</div>
		</div>
	</section>
	...
	<div class="container">
		<div class = "row">
			<table class="table table-striped" style="text-align:center; border:1px solid #dddddd"> 
				...
				<tbody>
					...
					<tr>
						...
						<td><%= list.get(i).getUserHakbun() %></td>
					</tr>
					<%
						}
					%>
			...
			<%
				if (pageNumber != 1) {
			%>
				<a href="meminfo.jsp?pageNumber=<%=pageNumber - 1%>" class="btn btn-success btn-arrow-left">이전</a>
			<%
				}
				if (userDAO.nextPage(pageNumber + 1)) {
			%>
				<a href="meminfo.jsp?pageNumber=<%=pageNumber + 1%>" class="btn btn-success btn-arrow-left">다음</a>
			<%
				}
			%>
		</div>
