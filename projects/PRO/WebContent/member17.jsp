		...
		<div class="container">				
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> Member</a><span class="lnr lnr-arrow-right"></span>  <a href="member17.jsp"> 17학번</a></p>
				</div>	
			</div>
		</div>
	</section>
